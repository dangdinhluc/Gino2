...
export function MainLayout() {
  ...
  const isTokuteiMenuRoute = /^\/app\/(courses|enrollments|practice|review|exams|profile|settings)(?:\/|$)/.test(location.pathname);
  ...
  return (
    <div className="app-layout-root flex h-[100dvh] overflow-hidden">
      ...
      {!isFlashcardFocusRoute && !isExamRunnerRoute && <MobileAITutorPopover />}
    </div>
  );
}
