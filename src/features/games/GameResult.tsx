  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#0F1419] p-4">
      <motion.div
        ...
        className="w-full max-w-sm rounded-[28px] border-2 bg-white p-6 text-center shadow-[0_0_60px_rgba(0,0,0,0.3)] md:p-8"
      ...
      >
        ...
        <p className="mt-1 text-sm font-semibold text-gray-500">Hoàn thành!</p>

        <div className="mt-5 grid grid-cols-3 gap-2">
          <div className="rounded-2xl bg-gray-50 px-3 py-3">
            <div className="text-[10px] font-bold uppercase text-gray-400">Điểm</div>
            <div className="mt-1 text-xl font-black text-gray-900">{score}</div>
          </div>
          <div className="rounded-2xl bg-gray-50 px-3 py-3">
            <div className="text-[10px] font-bold uppercase text-gray-400">Combo</div>
            <div className="mt-1 text-xl font-black text-gray-900">x{maxCombo}</div>
          </div>
          <div className="rounded-2xl bg-gray-50 px-3 py-3">
            <div className="text-[10px] font-bold uppercase text-gray-400">Đúng</div>
            <div className="mt-1 text-xl font-black text-gray-900">{accuracy}%</div>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col gap-2">
          <button
            onClick={onRestart}
            className="inline-flex items-center justify-center gap-2 rounded-2xl border border-gray-200 px-5 py-3 text-sm font-bold text-gray-700 transition-colors hover:bg-gray-50"
          >
