...
export function VocabularyOverviewCard({ stats = defaultStats }: VocabularyOverviewCardProps) {
  return (
    <section className="relative overflow-hidden rounded-[22px] border border-[#fde6d2] bg-gradient-to-r from-[#fff9f3] via-[#fff5eb] to-[#ffeedd] px-3.5 py-2.5 shadow-2xs lg:min-h-[9rem] lg:px-7 lg:py-4">
      ...
      <div className="flex items-center justify-between gap-3 lg:gap-6">
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="flex h-8.5 w-8.5 shrink-0 items-center justify-center rounded-xl bg-gradient-to-tr from-[#d83a00] to-[#f26522] text-xs font-black text-white shadow-2xs lg:h-12 lg:w-12 lg:rounded-2xl lg:text-base">
            あ
          </div>
          <div className="min-w-0">
            <div className="flex items-center gap-1 font-[var(--font-heading)] text-sm font-extrabold tracking-[-0.01em] text-[#172033] sm:text-base lg:text-xl">
              <span>Kho từ vựng</span>
              <Sparkles size={13} className="text-amber-500 fill-amber-400" />
            </div>
            <p className="truncate text-[11px] font-medium text-[#717d8f] lg:text-sm">
        ...
        <div className="relative shrink-0 -my-3 -mr-2">
          <img
            ...
            className="h-20 w-auto object-contain drop-shadow-sm sm:h-24 md:h-28 lg:h-36"
          />
        </div>
      </div>
    </section>
