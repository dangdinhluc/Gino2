  ...
  return (
    <div className="mx-auto flex w-full max-w-[720px] flex-col items-center gap-4 pb-8 text-center">
      <section className="relative w-full overflow-hidden rounded-2xl border border-orange-200/80 bg-gradient-to-br from-[#fffaf3] via-[#fff5eb] to-[#ffeedd] p-6 sm:p-9">
        ...
        <div className="mx-auto mt-4 flex items-center justify-center gap-2 rounded-xl border border-amber-200 bg-amber-50 px-4 py-2.5 text-sm font-black text-amber-800">
          <Zap size={16} className="fill-amber-400 text-amber-600" /> +{sessionXp} XP đã cộng vào chuỗi học tập
        </div>
